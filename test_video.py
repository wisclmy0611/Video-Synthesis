...
from model import Generator, VideoGenerator
import utils
    ...
    for image_name in sorted(os.listdir(args.input_dir)):
        ...
        with torch.no_grad():
            ...
            if last_generated is None:
                last_generated = net(utils.cat_images(input, input), args.upsample_align)
            out = net(utils.cat_images(input, last_generated), args.upsample_align)
            last_generated = net(utils.cat_images(input, input), args.upsample_align)
