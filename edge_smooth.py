...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='dataset/anime', help='dataset_name')
...
def make_edge_smooth(dataset_name, img_size) :
    file_list = glob(f'{dataset_name}/style/*/*.*')
    ...
    for f in tqdm(file_list):
        save_dir = f'{dataset_name}/smooth/{os.path.basename(os.path.dirname(f))}'
